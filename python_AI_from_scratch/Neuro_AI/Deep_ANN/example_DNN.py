...
from DNN_Class import DNN_base

clf = DNN_base(layers_dims,num_iterations=3000,learning_rate=0.0075,
...
pred_train = clf.predict(train_x, train_y, parameters)
pred_test = clf.predict(test_x, test_y, parameters)
